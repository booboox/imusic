...
watch(
  ...
  async () => {
    ...
    userPlaylist(globalstore.userInfo.userId).then(({ data }) => {
  ...
  <el-scrollbar class="left-side">
    <div class="side-wrapper">
      <div class="side-title flex" style="justify-content: center">
        <img src="@/static/img/头像.jpg" alt="" style="width: 150px" />
      </div>
      <div class="side-menu">
        <router-link to="/">
      ...
      <div class="side-menu">
        <router-link to="/musiclibrary">
          ...
          >
            ...
            ></path>
            <path
              d="M633.290116 786.234494V196.481793L792.893157 36.878752v217.994397l-159.603041 159.603041"
              fill="#525B72"
              p-id="8020"
            ></path>
            <path
            ...
            ></path>
            <path
              d="M618.804962 349.995742L779.534854 189.269948l28.970308 28.970308-160.725794 160.729892z"
              fill="#525B72"
              opacity=".15"
              p-id="8023"
            ></path>
    ...
    <div class="side-wrapper" v-if="list.length">
      ...
      <div class="side-menu">
        ...
        >
          <img
            :src="item.coverImgUrl + '?param=28y28'"
            alt=""

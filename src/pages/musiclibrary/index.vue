...
const state = reactive({
  activeName: "first",
  buttonList: [
  { title: "每日推荐", color: "#67C23A" },
  { title: "最新MV", color: "#E6A23C" },
  { title: "排行榜", color: "#F56C6C" },
  { title: "歌手", color: "#409EFF" },
],
  currentPage: 1,
  songTotal: 0,
  tableData: [],
});
const { activeName, buttonList, tableData } = toRefs(state);
